...
$result = mysql_query("SELECT * FROM offerbooking ORDER BY id DESC");
?>

<html>
<head>	
	<title>Booked offer List</title>
    ...
    <?php
      if(isset($_SESSION['name']) && !empty($_SESSION['name']))
     {
      ...
      else
      {
          ...
          header("Location:showofferedcustomer.php");
      }
      ?>
